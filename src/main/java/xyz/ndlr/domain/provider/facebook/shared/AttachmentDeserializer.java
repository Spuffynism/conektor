package xyz.ndlr.domain.provider.facebook.shared;
...
import xyz.ndlr.domain.provider.facebook.sendAPI.message.attachment.AbstractPayload;
import xyz.ndlr.domain.provider.facebook.sendAPI.message.attachment.MultimediaPayload;
