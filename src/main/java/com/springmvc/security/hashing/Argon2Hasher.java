package com.springmvc.security.hashing;
...
public class Argon2Hasher implements IPasswordHasher {
    ...
    private static final int HASHING_ITERATIONS = 10; // prend ~ 1 seconde à hasher
    private static final int KIBIBYTES_MEMORY_USAGE = 65536;
    private static final int NB_THREADS_AND_COMPUTES_LANES = 1;
