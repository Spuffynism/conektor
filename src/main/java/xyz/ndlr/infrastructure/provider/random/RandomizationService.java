package xyz.ndlr.infrastructure.provider.random;
...
import xyz.ndlr.infrastructure.provider.random.card.Card;
import xyz.ndlr.infrastructure.provider.random.card.Suit;
import xyz.ndlr.infrastructure.provider.random.card.Value;
